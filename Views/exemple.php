<?php
// -------------------------------
// Données simulées (normalement stockées en DB)
// -------------------------------
$annonces = [
    [
        "id" => 1,
        ...
        "categorie" => "Mode",
        "prix" => 45,
        "description" => "Veste homme taille M, très peu portée, parfait pour l'hiver.",
    ...
    [
        ...
        "categorie" => "Mode",
        "prix" => 60,
        "description" => "Nike Air Max, taille 42, état neuf, à peine utilisées.",
    ...
    [
        ...
        "prix" => 500,
        "description" => "Très bon état, 128 Go, vendu avec chargeur et boîte.",
    ...
    [
        ...
        "prix" => 30,
        "description" => "Sac en cuir marron, style vintage, bonne capacité.",
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="index.php?cat=Électronique">Électronique</a></li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">❤️ Favoris</a>
        </li>
      </ul>
      ...
      <!-- <div class="d-flex">
        ...
        <a href="#" class="btn btn-warning fw-bold">➕ Déposer une annonce</a>
      </div> -->
...
<a href="#" class="btn btn-outline-light me-2">💬</a>

<!-- Bouton login -->
<a href="#" class="btn btn-block btn-light me-2" data-bs-toggle="modal" data-bs-target="#loginModal">🔑 Connexion</a>
...
<!-- Bouton -->
<button class="btn btn-block btn-primary" data-bs-toggle="modal" data-bs-target="#chatModal">💬 Contacter le vendeur</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:300px; overflow-y:auto;">
        <div class="text-muted">[Vendeur] Bonjour, l’article est toujours dispo ✅</div>
      </div>
...
<!-- Bouton dépôt -->
<a href="#" class="btn btn-block btn-outline-danger" data-bs-toggle="modal" data-bs-target="#sellModal">➕ Vendre un article</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-success">
        <h5 class="modal-title">Déposer une annonce</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        <form>
          ...
          <div class="mb-3"><label>Prix (€)</label><input type="number" class="form-control"></div>
...
<?php if ($detail): ?>
    ...
    <div class="card shadow-lg">
        <img src="<?= base_url('img/valley.png') ?>" class="card-img-top" alt="<?= htmlspecialchars($detail['titre']) ?>"/>
        <div class="card-body">
            ...
            <h4 class="text-success fw-bold"><?= $detail['prix'] ?> €</h4>
            <a href="index.php" class="btn btn-outline-secondary mt-3">⬅ Retour aux annonces</a>
        </div>
    </div>
...
<?php else: ?>
    ...
    <form method="get" class="row g-3 mb-4">
        ...
        <div class="col-md-4">
            <select name="cat" class="form-select">
                ...
                <option value="Électronique" <?= $categorie=="Électronique"?"selected":"" ?>>Électronique</option>
    ...
    <div class="row">
        <?php if (empty($annonces_filtrees)): ?>
            <div class="col-12">
                <div class="alert alert-warning">Aucune annonce trouvée.</div>
            </div>
        <?php else: ?>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="text-danger fw-bold"><?= $a['prix'] ?> €</h6>
                            <a href="index.php?id=<?= $a['id'] ?>" class="btn btn-sm btn-primary mt-2">Voir l’annonce</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
...
<div class="bg-success text-white text-center p-5 mb-4 rounded shadow-sm">
    <h1 class="fw-bold">Bienvenue sur Mini Marketplace 👋</h1>
    <p class="lead">Achetez et vendez facilement, trouvez la bonne affaire près de chez vous.</p>
    <a href="#" class="btn btn-light btn-lg mt-2">Déposer une annonce</a>
</div>


<!-- Footer -->
<footer class="bg-dark text-white text-center py-3 mt-5">
    <p class="mb-0">© 2025 Mini Marketplace - Tous droits réservés</p>
    <small>
